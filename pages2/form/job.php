...
$content = "<ul class='nav nav-tabs' role='tablist'>
    <li role='presentation' class='active'><a href='#home' aria-controls='home' role='tab' data-toggle='tab'>Basic ".APPNAME."</a></li>
    <li role='presentation'><a href='#profile' aria-controls='profile' role='tab' data-toggle='tab'>Advance ".APPNAME."</a></li>
  </ul>
        ...
        <form class='form-horizontal' method='post'>
          <fieldset>
            ...
            <table class='table-responsive' width='100%'>
              <tr><td>Name</td><td>: </td><td><input type='text' name='name' id='name' placeholder='e.g. Find happy tweets' class='form-control' value='$job->j_name'></td><td><input type='checkbox' class='' name='retweet' id='retweet' ".($job->j_retweet?'checked':'')." value='1'/> Extract Re-Tweet?</td></tr>
