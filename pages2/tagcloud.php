...
$content = '<div id="wrapper">
  	<div id="second" class="tccontainer"></div>
    <div id="first" class="tccontainer"></div>
  	<div id="third" class="tccontainer"></div>
  	<div id="fourth" class="tccontainer"></div>
  </div>';
...
$content .= " ];";
$content .= "var words2 = [ ";
foreach ($q2 as $k2 => $w2) { $content .= '{text: "'.$k2.'", weight: '.($w2*4).', html: {title: "'.$w1.'"}},';  }
$content .= " ];";
$content .= "var words3 = [ ";
foreach ($q3 as $k3 => $w3) { $content .= '{text: "'.$k3.'", weight: '.($w3*4).', html: {title: "'.$w1.'"}},';  }
$content .= " ];";
$content .= "var words4 = [ ";
foreach ($q4 as $k4 => $w4) { $content .= '{text: "'.$k4.'", weight: '.($w4*4).', html: {title: "'.$w1.'"}},';  }
$content .= " ];";
